...
extension CalendarFeatureStrings {
    ...
    static let tr = CalendarFeatureStrings(title: "Takvim", panelCaption: "Takviminizi ve yaklaÅan randevularÄ±nÄ±zÄ± gÃ¶rÃ¼ntÃ¼leyin", calendarsListTitle: "Takvimler", hideCalendarHint: "Burada gizlenen takvimler, Ä±zgara ve gÃ¼ndemden kaldÄ±rÄ±lÄ±r; Takvim uygulamasÄ±ndan kaldÄ±rÄ±lmaz.", hubDescription: "MenÃ¼ Ã§ubuÄu panelinden aylÄ±k gÃ¶rÃ¼nÃ¼mÃ¼ ve yaklaÅan randevularÄ±nÄ±zÄ± gÃ¶rÃ¼ntÃ¼leyin.", permission: "YaklaÅan randevularÄ± gÃ¶stermek iÃ§in takvimlerinizi okur. Etkinlikler bu Mac’te kalÄ±r.", allow: "Takvim EriÅimine Ä°zin Ver", denied: "RandevularÄ±nÄ±zÄ± gÃ¶rmek iÃ§in Sistem AyarlarÄ±’nda takvim eriÅimine izin verin.", settings: "Sistem AyarlarÄ±’nÄ± AÃ§", requestFailed: "Takvim eriÅimi istenemedi. Tekrar deneyin.", empty: "YaklaÅan randevu yok", today: "BugÃ¼n", allDay: "TÃ¼m gÃ¼n", untitled: "BaÅlÄ±ksÄ±z etkinlik", openCalendar: "Takvimi AÃ§", previousMonth: "Ãnceki ay", nextMonth: "Sonraki ay")
    ...
    static let fr = CalendarFeatureStrings(title: "Calendrier", panelCaption: "Consultez votre calendrier et vos prochains rendez-vous", calendarsListTitle: "Calendriers", hideCalendarHint: "Les calendriers masquÃ©s ici sont retirÃ©s de la grille et de l’agenda, pas de l’app Calendrier elle-mÃªme.", hubDescription: "Consultez une vue mensuelle et vos prochains rendez-vous depuis le panneau de la barre des menus.", permission: "Lit vos calendriers pour afficher les prochains rendez-vous. Les Ã©vÃ©nements restent sur ce Mac.", allow: "Autoriser l’accÃ¨s au calendrier", denied: "Autorisez l’accÃ¨s au calendrier dans les RÃ©glages SystÃ¨me pour voir vos rendez-vous.", settings: "Ouvrir les RÃ©glages SystÃ¨me", requestFailed: "Impossible de demander l’accÃ¨s au calendrier. RÃ©essayez.", empty: "Aucun rendez-vous Ã  venir", today: "Aujourd’hui", allDay: "Toute la journÃ©e", untitled: "ÃvÃ©nement sans titre", openCalendar: "Ouvrir Calendrier", previousMonth: "Mois prÃ©cÃ©dent", nextMonth: "Mois suivant")
