...
struct CommandBarFeatureStrings {
    ...
    let sourceFirefoxBookmarks: String
    let firefoxBookmarksNotInstalled: String
    let sourceSafariBookmarks: String
    let safariBookmarksFDAReason: String
...
extension CommandBarFeatureStrings {
    static let enUS = CommandBarFeatureStrings(
        ...
        sourceFirefoxBookmarks: "Firefox Bookmarks",
        firefoxBookmarksNotInstalled: "Firefox isn't installed on this Mac.",
        sourceSafariBookmarks: "Safari Bookmarks",
        safariBookmarksFDAReason: "Command Bar needs Full Disk Access to search your Safari bookmarks.",
    ...
    static let ptBR = CommandBarFeatureStrings(
        ...
        sourceFirefoxBookmarks: "Favoritos do Firefox",
        firefoxBookmarksNotInstalled: "O Firefox não está instalado neste Mac.",
        sourceSafariBookmarks: "Favoritos do Safari",
        safariBookmarksFDAReason: "A Barra de comando precisa de Acesso total ao disco para pesquisar seus favoritos do Safari.",
    ...
    static let tr = CommandBarFeatureStrings(
        ...
        sourceChromeBookmarks: "Chrome Yer İşaretleri",
        kindBookmark: "Yer İşareti",
        bookmarksProfileFormat: "Profil: %@",
        chromeBookmarksNotInstalled: "Chrome bu Mac'e kurulu değil.",
        sourceFirefoxBookmarks: "Firefox Yer İşaretleri",
        firefoxBookmarksNotInstalled: "Firefox bu Mac'e kurulu değil.",
        sourceSafariBookmarks: "Safari Yer İşaretleri",
        safariBookmarksFDAReason: "Komut çubuğunun Safari yer işaretlerinizde arama yapabilmesi için Tam Disk Erişimi gerekir.",
    ...
    static let ru = CommandBarFeatureStrings(
        ...
        bookmarksProfileFormat: "Профиль: %@",
        chromeBookmarksNotInstalled: "Chrome не установлен на этом Mac.",
        sourceFirefoxBookmarks: "Закладки Firefox",
        firefoxBookmarksNotInstalled: "Firefox не установлен на этом Mac.",
        sourceSafariBookmarks: "Закладки Safari",
        safariBookmarksFDAReason: "Командной панели нужен полный доступ к диску, чтобы искать в ваших закладках Safari.",
    ...
    static let es = CommandBarFeatureStrings(
        ...
        sourceChromeBookmarks: "Marcadores de Chrome",
        kindBookmark: "Marcador",
        bookmarksProfileFormat: "Perfil: %@",
        chromeBookmarksNotInstalled: "Chrome no está instalado en esta Mac.",
        sourceFirefoxBookmarks: "Marcadores de Firefox",
        firefoxBookmarksNotInstalled: "Firefox no está instalado en esta Mac.",
        sourceSafariBookmarks: "Marcadores de Safari",
        safariBookmarksFDAReason: "La Barra de comandos necesita Acceso total al disco para buscar en tus marcadores de Safari.",
    ...
    static let de = CommandBarFeatureStrings(
        ...
        sourceChromeBookmarks: "Chrome-Lesezeichen",
        kindBookmark: "Lesezeichen",
        bookmarksProfileFormat: "Profil: %@",
        chromeBookmarksNotInstalled: "Chrome ist auf diesem Mac nicht installiert.",
        sourceFirefoxBookmarks: "Firefox-Lesezeichen",
        firefoxBookmarksNotInstalled: "Firefox ist auf diesem Mac nicht installiert.",
        sourceSafariBookmarks: "Safari-Lesezeichen",
        safariBookmarksFDAReason: "Die Befehlsleiste benötigt Festplattenvollzugriff, um Ihre Safari-Lesezeichen zu durchsuchen.",
    ...
    static let fr = CommandBarFeatureStrings(
        ...
        sourceChromeBookmarks: "Favoris Chrome",
        kindBookmark: "Favori",
        bookmarksProfileFormat: "Profil : %@",
        chromeBookmarksNotInstalled: "Chrome n’est pas installé sur ce Mac.",
        sourceFirefoxBookmarks: "Favoris Firefox",
        firefoxBookmarksNotInstalled: "Firefox n’est pas installé sur ce Mac.",
        sourceSafariBookmarks: "Favoris Safari",
        safariBookmarksFDAReason: "La Barre de commande a besoin de l’Accès complet au disque pour rechercher dans vos favoris Safari.",
    ...
    static let it = CommandBarFeatureStrings(
        ...
        sourceChromeBookmarks: "Segnalibri Chrome",
        kindBookmark: "Segnalibro",
        bookmarksProfileFormat: "Profilo: %@",
        chromeBookmarksNotInstalled: "Chrome non è installato su questo Mac.",
        sourceFirefoxBookmarks: "Segnalibri Firefox",
        firefoxBookmarksNotInstalled: "Firefox non è installato su questo Mac.",
        sourceSafariBookmarks: "Segnalibri Safari",
        safariBookmarksFDAReason: "La Barra dei comandi richiede l'Accesso completo al disco per cercare nei tuoi segnalibri Safari.",
    ...
    static let ja = CommandBarFeatureStrings(
        ...
        sourceChromeBookmarks: "Chrome ブックマーク",
        kindBookmark: "ブックマーク",
        bookmarksProfileFormat: "プロフィール: %@",
        chromeBookmarksNotInstalled: "このMacにはChromeがインストールされていません。",
        sourceFirefoxBookmarks: "Firefox ブックマーク",
        firefoxBookmarksNotInstalled: "このMacにはFirefoxがインストールされていません。",
        sourceSafariBookmarks: "Safari ブックマーク",
        safariBookmarksFDAReason: "コマンドバーが Safari のブックマークを検索するにはフルディスクアクセスが必要です。",
    ...
    static let ko = CommandBarFeatureStrings(
        ...
        linksTitle: "내 단축키",
        sourceChromeBookmarks: "Chrome 북마크",
        kindBookmark: "북마크",
        bookmarksProfileFormat: "프로필: %@",
        chromeBookmarksNotInstalled: "이 Mac에 Chrome이 설치되어 있지 않습니다.",
        sourceFirefoxBookmarks: "Firefox 북마크",
        firefoxBookmarksNotInstalled: "이 Mac에 Firefox가 설치되어 있지 않습니다.",
        sourceSafariBookmarks: "Safari 북마크",
        safariBookmarksFDAReason: "명령 막대가 Safari 북마크를 검색하려면 전체 디스크 접근 권한이 필요합니다.",
    ...
    static let zhHans = CommandBarFeatureStrings(
        ...
        linksTitle: "你的快捷方式",
        sourceChromeBookmarks: "Chrome 书签",
        kindBookmark: "书签",
        bookmarksProfileFormat: "档案: %@",
        chromeBookmarksNotInstalled: "这台 Mac 上未安装 Chrome。",
        sourceFirefoxBookmarks: "Firefox 书签",
        firefoxBookmarksNotInstalled: "这台 Mac 上未安装 Firefox。",
        sourceSafariBookmarks: "Safari 书签",
        safariBookmarksFDAReason: "命令栏需要完全磁盘访问权限才能搜索您的 Safari 书签。",
    ...
    static let zhTW = CommandBarFeatureStrings(
        ...
        linksTitle: "你的捷徑",
        sourceChromeBookmarks: "Chrome 書籤",
        kindBookmark: "書籤",
        bookmarksProfileFormat: "檔案: %@",
        chromeBookmarksNotInstalled: "這台 Mac 上未安裝 Chrome。",
        sourceFirefoxBookmarks: "Firefox 書籤",
        firefoxBookmarksNotInstalled: "這台 Mac 上未安裝 Firefox。",
        sourceSafariBookmarks: "Safari 書籤",
        safariBookmarksFDAReason: "指令列需要完整磁碟存取權限才能搜尋你的 Safari 書籤。",
